...
import { useAssignTicket, useUpdateTicketStatus, useArchiveTicket } from '@/hooks/useTickets';
...
function BulkActionBar({
  selectedIds, onClear, tickets, onAssign, onChangeStatus, onClose, onArchive, assignees, statuses,
}: BulkActionBarProps) {
