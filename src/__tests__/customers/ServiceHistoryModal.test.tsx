  ...
  events: [
    {
      id: 'ev1',
      eventType: 'activated',
      occurredAt: '2023-01-01T13:00:00Z',
    ...
    },
    {
      ...
      occurredAt: '2023-06-15T17:30:00Z',
    ...
    },
    {
      ...
      occurredAt: '2023-09-20T12:15:00Z',
...
describe('ServiceHistoryModal', () => {
  ...
  it('renders event dates formatted with formatDateTimeShort', () => {
    ...
    // AR (UTC-3): 13:00Z -> 10:00, 17:30Z -> 14:30, 12:15Z -> 09:15.
  ...
  // occurredAt with Z is a real wall-clock timestamp; formatDateTimeShort renders
  // it in Argentina time (UTC-3), deterministically — independent of the runner TZ.
  it('renders occurredAt with trailing Z in Argentina time', () => {
      ...
      events: [
        {
          ...
          // formatDateTimeShort renders this in Argentina time (UTC-3) — CORRECT
    ...
    // 13:45Z -> 10:45 AR (UTC-3), deterministic regardless of the runner timezone.
    expect(screen.getByText('01 ene 2023 - 10:45')).toBeInTheDocument();
  });
