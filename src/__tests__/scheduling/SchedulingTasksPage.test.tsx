...
vi.mock('@/hooks/useScheduling', () => ({
  ...
  useSetTaskGeneralStatus:   vi.fn(() => ({ mutate: vi.fn(), mutateAsync: vi.fn().mockResolvedValue(undefined), isPending: false })),
  useArchiveTask:            vi.fn(() => ({ mutate: vi.fn(), mutateAsync: vi.fn().mockResolvedValue(undefined), isPending: false })),
}));
